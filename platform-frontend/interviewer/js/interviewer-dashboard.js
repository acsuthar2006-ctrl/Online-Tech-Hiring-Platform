...
window.viewCandidates = async (companyId, positionId, positionTitle, companyName) => {
  ...
  try {
    ...
    const renderCandidateRow = (c) => {
      ...
      return `
        <div data-candidate-id="${c.id}" style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;margin-bottom:10px;display:flex;justify-content:space-between;align-items:flex-start;">
          <div>

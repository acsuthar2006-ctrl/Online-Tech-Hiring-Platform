...
echo "Candidate 1: http://localhost:5173/index.html?room=$MEETING_ID&role=candidate"
echo "Candidate 2: http://localhost:5173/index.html?room=$MEETING_ID&role=candidate"
echo ""

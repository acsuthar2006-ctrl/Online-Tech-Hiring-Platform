...
- **Result**: People could access your site from anywhere, making it _feel_ like it was on the cloud, but it was actually running on your machine.
...
| File                      | Purpose                                                              |
| :------------------------ | :------------------------------------------------------------------- |
| `NGROK_GUIDE.md`          | How to expose your _local_ server to the internet for quick testing. |
| `AWS_DEPLOYMENT_GUIDE.md` | How to push your code to a _real_ AWS server for production.         |
